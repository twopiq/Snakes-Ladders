...
| `BACKUP_CHAT_ID` | Telegram chat raqamingiz ([@userinfobot](https://t.me/userinfobot) aytadi) | **Bazani Telegram'ga zaxiralaydi** — server qayta ishga tushganda ma'lumot shundan tiklanadi |
